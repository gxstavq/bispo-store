-- Treat stock-audit movements as product history during permanent deletion.
-- Incremental and non-destructive: only replaces the existing RPC body.
...
begin
  ...
  select exists (
    ...
    where movements.product_id = target_product_id
  ) into has_history;
